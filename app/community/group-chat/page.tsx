...
export default function GroupChatPage(){
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 py-12 px-4 sm:px-6 lg:px-8 text-white">
      ...
      <h1 className="text-3xl font-playfair font-bold golden-text mb-8">💬 グループチャット</h1>

      <p className="text-lg text-white/80 mb-8 max-w-2xl">ここでは多人数でのリアルタイムチャットを体験できます。（デモページ）</p>

      <div className="bg-white/10 p-6 rounded-lg border border-white/20 text-center">
        <p className="text-white/70">チャット機能は現在開発中です。近日公開予定！</p>
      </div>
    </div>
  )
} 