...
export default function SuperPlanPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-6">
      <h1 className="text-4xl font-bold text-white mb-6">Super プラン (¥500/月)</h1>
      <ul className="list-disc list-inside text-lg text-gray-300 mb-8 space-y-1 max-w-xl">
